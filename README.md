...
The largest remaining gaps against `docs/requirements.md` are parser/typesetter/page-fragment-level partial recompilation, full cross-stage partition parallelism beyond the PDF render stage, `tikz`/`pgf`, higher-fidelity source-span tracking for SyncTeX, and a fully memory-mapped production asset-bundle runtime.
