...
- Exact generation commands used:
  ...
  - `/Library/TeX/texbin/pdflatex -interaction=nonstopmode -output-directory=. '\pdfcompresslevel=0 \pdfobjcompresslevel=0 \input{../rotated_image.tex}'`
  - `/Library/TeX/texbin/pdflatex -interaction=nonstopmode -output-directory=. '\pdfcompresslevel=0 \pdfobjcompresslevel=0 \input{../subfigures.tex}'`
  - `/Library/TeX/texbin/pdflatex -interaction=nonstopmode -output-directory=. '\pdfcompresslevel=0 \pdfobjcompresslevel=0 \input{../figure_placement.tex}'`
  - `/Library/TeX/texbin/pdflatex -interaction=nonstopmode -output-directory=. '\pdfcompresslevel=0 \pdfobjcompresslevel=0 \input{../wrapped_text.tex}'`
  - `/Library/TeX/texbin/pdflatex -interaction=nonstopmode -output-directory=. '\pdfcompresslevel=0 \pdfobjcompresslevel=0 \input{../multiple_pages_images.tex}'`
...
- `rotated_image.tex` -> `rotated_image.pdf`
- `subfigures.tex` -> `subfigures.pdf`
- `figure_placement.tex` -> `figure_placement.pdf`
- `wrapped_text.tex` -> `wrapped_text.pdf`
- `multiple_pages_images.tex` -> `multiple_pages_images.pdf`
