...
| 最終更新日 | 2026-03-17 |
| ステータス | ドラフト |
| 入力 | [requirements.md](requirements.md) v0.1.28, [domain_model.md](domain_model.md) v0.1.29 |
...
graph LR
    ...
    Transport -->|serves active artifact| Pdf
...
| Font Management | `FontSpec` 正規化、フォント解決、TFM/OpenType 読み込み (`REQ-FUNC-017` / `REQ-FUNC-018`)、fontspec サポート (`REQ-FUNC-025`)、メトリクス・グリフ供給 | `ResolvedFont`, `FontMetrics`, `FontEmbeddingPlan` |
...
### 10.12 セキュリティ境界 (`REQ-NF-005`, `REQ-NF-006`)
